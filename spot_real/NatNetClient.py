...
class NatNetClient:
    ...
    def __init__( self ):
        ...
        self.server_ip_address = "10.0.0.229"

        # Change this value to the IP address of your local network interface
        self.local_ip_address = "10.0.0.224"
    ...
    def __unpack_rigid_body( self, data, major, minor, rb_num):
        ...
        if self.rigid_body_listener is not None:
            self.rigid_body_listener(new_id, rigid_pos, rigid_rot)
            #print(rigid_body.rb_marker_list)
...
#Unpack Mocap Data Functions
    ...
    def __unpack_labeled_marker_data( self, data, packet_size, major, minor):
        ...
        if( ( major == 2 and minor > 3 ) or major > 2 ):
            ...
            #self.labeled_marker_listener
            if self.labeled_marker_listener is not None:
                self.labeled_marker_listener(labeled_marker_data.labeled_marker_list)
    ...
    def __unpack_mocap_data( self, data : bytes, packet_size, major, minor):
        ...
        if self.new_frame_listener is not None:
            ...
            data_dict["unlabeled_markers_data"] = unlabel_data
    ...
    def __unpack_rigid_body_description( self, data, major, minor):
        ...
        if self.rigid_body_listener is not None:
            self.rigid_body_listener(rb_desc)
