...
FRANKA_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"/home/carol/Project/Tasksuite/MoDeTaskSuite/asset/franka/Franka.usd",
...
without finger and with high damping(PD)
...
SPOT_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path='/home/carol/Project/benchmark/MoDeSuite/asset/spot/spot_arm.usd',
#f"{ISAAC_NUCLEUS_DIR}/Robots/BostonDynamics/spot/spot.usd",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            ".*_kn": -1.5,  # all knees
            "arm0_sh0": 0,
            "arm0_sh1": -3.14,#-3.14, #0
            "arm0_el0": 3.14,#3.14, #0
            "arm0_el1": 0,
            "arm0_wr0": 0,
            "arm0_wr1": 0,
            #"arm0_f1x": 0,
